...
export const metadata:Metadata={
  ...
  title:{default:"TechSignal — Useful ideas. Smarter decisions.",template:"%s | TechSignal"},
...
export default function RootLayout({children}:{children:React.ReactNode}){
  return <html lang="en"><body><Header/><main>{children}</main><Footer/><ConsentProvider/><Analytics/></body></html>;
}