...
export default async function ArticlePage({params}:{params:Promise<{slug:string}>}){
 ...
 {a.slug==="34-prodentim-alternatives-what-to-compare"&&<AffiliateCTA articleSlug={a.slug} position="comparison-final" offerKey="prodentim" variant="card" label="Buy Now →"/>}
