...
export async function generateMetadata({params}:{params:Promise<{slug:string}>}):Promise<Metadata>{
 ...
 return{title:a.title,description:a.description,keywords:a.keywords,authors:[{name:desk.name,url:base+"/author/guidesignal-editorial-team/"}],robots:{index:true,follow:true,googleBot:{index:true,follow:true,"max-image-preview":"large","max-snippet":-1,"max-video-preview":-1}},alternates:{canonical:url},openGraph:{type:"article",siteName:"GuideSignal",title:a.title,description:a.description,url,publishedTime:a.date,modifiedTime:a.updated,authors:[desk.name],section:a.categoryName,tags:a.keywords},twitter:{card:"summary",title:a.title,description:a.description}};
}
