...
export default async function ArticlePage({params}:{params:Promise<{slug:string}>}){
 ...
 {a.offerKey&&<AffiliateCTA articleSlug={a.slug} position="article-top" offerKey={a.offerKey}/>}<AdSlot slot={a.slug+"-contextual"} scriptUrl={process.env.NEXT_PUBLIC_AD_ARTICLE_SCRIPT_URL} zone={process.env.NEXT_PUBLIC_AD_ARTICLE_ZONE}/>
