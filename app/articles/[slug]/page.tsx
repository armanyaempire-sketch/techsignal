...
export default async function ArticlePage({params}:{params:Promise<{slug:string}>}){
 ...
 const articleSchema={"@context":"https://schema.org","@type":"Article","headline":a.title,"description":a.description,"datePublished":a.date,"dateModified":a.updated,"inLanguage":"en","wordCount":totalWords,"isAccessibleForFree":true,"mainEntityOfPage":{"@type":"WebPage","@id":articleUrl},"author":{"@type":"Organization","@id":siteUrl+"#editorial-team","name":a.author,"url":siteUrl+"/author/guidesignal-editorial-team/"},"reviewedBy":{"@type":"Organization","@id":siteUrl+"#"+desk.id,"name":desk.name,"description":desk.standard,"url":siteUrl+"/author/guidesignal-editorial-team/"},"publisher":{"@type":"Organization","@id":siteUrl+"#organization","name":"GuideSignal","url":siteUrl},"articleSection":a.categoryName,"keywords":a.keywords};
