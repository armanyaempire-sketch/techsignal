...
export default function Home(){
 ...
 <div className="container"><div className="home-ad-stack"><NativeBanner slot="home-top-native-horizontal" variant="horizontal"/><NativeBanner slot="home-468-top-native-horizontal" variant="horizontal"/></div></div>
