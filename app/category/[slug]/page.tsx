  ...
  <section className="section category-pillar">
   <div className="container category-hub-layout">
    <main className="category-hub-main">
     ...
     {(slug==="health-fitness"||slug==="womens-health-beauty")&&<section className="category-trust-block"><div><span className="eyebrow">Featured product research</span><h2>{slug==="health-fitness"?"ProDentim: buyer due diligence":"FemiCore: buyer due diligence"}</h2><p>{slug==="health-fitness"?"Review the seller’s current claims, label details and purchase terms before considering an oral-care supplement.":"Review seller claims, product details, evidence context and purchase terms before considering a bladder-support supplement."}</p></div><Link className="button button-secondary" prefetch={false} href={slug==="health-fitness"?"/health-fitness/products/prodentim/":"/womens-health-beauty/products/femicore/"}>{slug==="health-fitness"?"Read the ProDentim research page →":"Read the FemiCore research page →"}</Link></section>}
