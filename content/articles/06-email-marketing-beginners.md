...
description: Understand the basic email marketing system from list building to segmentation and measurement.
category: e-business
...
A signup should explain the value of joining.

Examples include:

- a weekly practical guide,
...
- new subscribers,
- repeat readers,
- readers interested in a particular topic,
- customers,
